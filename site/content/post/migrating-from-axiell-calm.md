...
howto:
  ...
  steps:
    ...
    - name: "Deployment to AWS London"
      text: "The per-customer mapping is deployed to UK based AWS containers and S3 for continuous production of import files for AtoM."
