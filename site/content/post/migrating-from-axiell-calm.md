...
faq:
  ...
  - q: "Why is CALM migration so difficult?"
    a: >-
      CALM has been in continuous use in UK archives, museums and libraries for around thirty years. Each repository has developed its own local conventions — the nine UserText fields, UserPeriod and UserDate fields have often been repurposed across projects and decades. Volunteers ten years ago may have used free-text PersonName while others used PersonCode. Migration is therefore not a technical exercise alone: it is a curatorial exercise in disambiguating and standardising thirty years of accumulated practice, and can only be done side by side with the client.
